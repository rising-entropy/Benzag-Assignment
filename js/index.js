        ...
        for (var i = 0; i < 30; i++) {
            urlLst.push(data[i].download_url);
             ...
             //var auth2 = data[i+1].author;
                 //$(".pictures").append("<div class='col-lg-6 col-md-6 col-sm-12'><img src='"+linko+"' class='img-fluid pic' data-wow-delay='0.3s' alt='"+auth+"'><img src='"+linko2+"' class='img-fluid pic' data-wow-delay='0.3s' alt='"+auth2+"'></div>");
